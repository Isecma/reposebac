...
public class CubosEnEnableDisable : MonoBehaviour
{
    ...
    {
        objToSpawn = new GameObject("PrimerCubo");
        ...
        objToSpawn.transform.position = new Vector3(Random.value, Random.value, Random.value);
    }
    private void OnDisable()
    {
        ...
        var meshRendererMaterial = objToSpawn.GetComponent<MeshRenderer>().material;
        meshRendererMaterial.color = Color.white;
        objToSpawn.transform.position = new Vector3(Random.Range(-6,6), Random.Range(-6, 6), Random.Range(-6, 6));
    }
}
